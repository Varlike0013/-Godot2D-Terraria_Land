...
func update_label_attribute(current_player:Player):
    ...
    label_attribute_vigor.update(current_player.get_attribute_rating(rating_value_vigor),current_player.rating_value_vigor,current_player.attribute_vigor)
    label_attribute_mind.update(current_player.get_attribute_rating(rating_value_mind),current_player.rating_value_mind,current_player.attribute_mind)
    label_attribute_endurance.update(current_player.get_attribute_rating(rating_value_endurance),current_player.rating_value_endurance,current_player.attribute_endurance)
    label_attribute_strength.update(current_player.get_attribute_rating(rating_value_strength),current_player.rating_value_strength,current_player.attribute_strength)
    label_attribute_dexterity.update(current_player.get_attribute_rating(rating_value_dexterity),current_player.rating_value_dexterity,current_player.attribute_dexterity)
    label_attribute_intelligence.update(current_player.get_attribute_rating(rating_value_intelligence),current_player.rating_value_intelligence,current_player.attribute_intelligence)
...
func change_display():
    if is_display_attribute:
        attributelVBox.visiable = true
        rich_text_label.visiable = false
    else:
        attributelVBox.visiable = false
        rich_text_label.visiable = true
